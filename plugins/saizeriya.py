...
saizeriyaGDMenu = (
    ...
    SaizeriyaMenuItem(id=1646, name='卡拉布里亚风味五花肉', price=22),
    SaizeriyaMenuItem(id=1563, name='布拉塔芝士意面', price=18),
    SaizeriyaMenuItem(id=1756, name='斯特拉恰特拉', price=13),
    SaizeriyaMenuItem(id=1910, name='莫斯卡托高泡葡萄酒（750ml）', price=58),
    SaizeriyaMenuItem(id=1201, name='原制芝士（马苏里拉 切达）', price=5),
    ...
    SaizeriyaMenuItem(id=1221, name='人气小吃拼盘', price=28),
    ...
    SaizeriyaMenuItem(id=3370, name='鸡肉培根小匹萨加芝士（6英寸）', price=19),
    SaizeriyaMenuItem(id=3387, name='榴莲小匹萨加芝士（6英寸）', price=25),
    SaizeriyaMenuItem(id=3369, name='罗勒酱鸡肉小匹萨加芝士（6英寸）', price=22),
    ...
    SaizeriyaMenuItem(id=1370, name='鸡肉培根小匹萨（6英寸）', price=15),
    SaizeriyaMenuItem(id=1369, name='罗勒酱鸡肉小匹萨（6英寸）', price=18),
    ...
    SaizeriyaMenuItem(id=1435, name='芝士香烤鸡肉局饭', price=23),
    ...
    SaizeriyaMenuItem(id=1403, name='肉酱局饭', price=19),
    SaizeriyaMenuItem(id=1402, name='芝士肉酱局饭', price=23),
    ...
    SaizeriyaMenuItem(id=1021, name='水果沙拉（橄榄油香醋汁）', price=9),
    ...
    SaizeriyaMenuItem(id=1012, name='水果沙拉（萨莉亚沙拉酱）', price=9),
    SaizeriyaMenuItem(id=1011, name='金枪鱼沙拉（萨莉亚沙拉酱）', price=12),
    SaizeriyaMenuItem(id=1273, name='意式小吃拼盘配意式香芹酱', price=28),
    SaizeriyaMenuItem(id=1299, name='柠檬瓣', price=1),
    SaizeriyaMenuItem(id=1210, name='橄榄油香醋汁', price=1),
    ...
    SaizeriyaMenuItem(id=1202, name='黑椒酱', price=2),
    ...
    SaizeriyaMenuItem(id=1420, name='金枪鱼局意面', price=18),
    SaizeriyaMenuItem(id=1419, name='肉酱香肠芝士烤饭(含酸菜)', price=18),
    SaizeriyaMenuItem(id=1416, name='香烤鸡肉局饭', price=18),
    SaizeriyaMenuItem(id=1410, name='海鲜局意面', price=18),
    SaizeriyaMenuItem(id=1409, name='米饭', price=2),
    SaizeriyaMenuItem(id=1408, name='肉酱局意面', price=18),
    SaizeriyaMenuItem(id=1404, name='鸡排烤饭', price=20),
    SaizeriyaMenuItem(id=1415, name='芝士香烤鸡肉局饭', price=22),
    ...
    SaizeriyaMenuItem(id=1901, name='独酌红葡萄酒', price=3),
    SaizeriyaMenuItem(id=1903, name='独酌白葡萄酒', price=3),
)
